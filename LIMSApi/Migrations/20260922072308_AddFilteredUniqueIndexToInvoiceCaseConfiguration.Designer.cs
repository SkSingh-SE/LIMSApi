...
namespace LIMSApi.Migrations
{
    ...
    [Migration("20260922072308_AddFilteredUniqueIndexToInvoiceCaseConfiguration")]
    partial class AddFilteredUniqueIndexToInvoiceCaseConfiguration
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LIMSApi.Models.InvoiceCase", b =>
                {
                    ...
                    b.HasIndex("LaboratoryTestID", "AnalysisTypeID", "EffectiveFrom")
                        .IsUnique()
                        .HasFilter("[IsActive] = 1");
            ...
            modelBuilder.Entity("LIMSApi.Models.MachiningChargeMaster", b =>
                {
                    ...
                    b.Property<string>("MachiningInstructions")
                        .HasMaxLength(500)
                        .HasColumnType("nvarchar(500)");
                    ...
                    b.Property<int>("SpecimenQuantity")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LIMSApi.Models.SamplePreparation", b =>
                {
                    ...
                    b.Property<decimal?>("CutThickness")
                        .HasColumnType("decimal(10,2)");

                    b.Property<decimal>("CuttingChargesTotal")
                        .HasColumnType("decimal(18,2)");

                    b.Property<string>("EdmCutting")
                        .HasMaxLength(200)
                        .HasColumnType("nvarchar(200)");

                    b.Property<decimal>("EdmCuttingCharge")
                        .HasColumnType("decimal(18,2)");

                    b.Property<long?>("EquipmentID")
                        .HasColumnType("bigint");

                    b.Property<string>("GasCutting")
                        .HasMaxLength(200)
                        .HasColumnType("nvarchar(200)");

                    b.Property<decimal>("GasCuttingCharge")
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.Property<string>("SpecialCutting")
                        .HasMaxLength(200)
                        .HasColumnType("nvarchar(200)");

                    b.Property<decimal>("SpecialCuttingCharge")
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.Property<decimal?>("WaterJetCuttingMins")
                        .HasColumnType("decimal(10,2)");
            ...
            modelBuilder.Entity("LIMSApi.Models.SamplePreparationTestItem", b =>
                {
                    b.Property<long>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<decimal>("CuttingTotal")
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.Property<decimal>("MachiningTotal")
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.Property<bool>("NoTesting")
                        .HasColumnType("bit");

                    b.Property<long>("PlannedTestMethodID")
                        .HasColumnType("bigint");

                    b.Property<string>("PlannedTestType")
                        .IsRequired()
                        .HasMaxLength(20)
                        .HasColumnType("nvarchar(20)");
                    ...
                    b.Property<decimal>("ResolvedCuttingRate")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal>("ResolvedMachiningRate")
                        .HasColumnType("decimal(18,2)");

                    b.Property<long>("SampleID")
                        .HasColumnType("bigint");

                    b.Property<long>("SamplePreparationID")
                        .HasColumnType("bigint");

                    b.Property<long?>("SpecimenPreparationMasterID")
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("SamplePreparationID");

                    b.HasIndex("SpecimenPreparationMasterID");

                    b.ToTable("SamplePreparationTestItems");
                });
            ...
            modelBuilder.Entity("LIMSApi.Models.SamplePreparationTestItem", b =>
                {
                    ...
                    b.HasOne("LIMSApi.Models.SamplePreparation", "SamplePreparation")
                        .WithMany("TestItems")
                        .HasForeignKey("SamplePreparationID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("LIMSApi.Models.MachiningChargeMaster", "SpecimenPreparationMaster")
                        .WithMany()
                        .HasForeignKey("SpecimenPreparationMasterID")
                        .OnDelete(DeleteBehavior.NoAction);
                    ...
                    b.Navigation("SpecimenPreparationMaster");
                });
