...
Write-Host " Building .NET Backend API (Staging/Dev)..." -ForegroundColor Cyan
Write-Host "==========================================" -ForegroundColor Cyan
...
# Prepare appsettings.Secrets.json with Staging (LimsDevConnection) as DefaultConnection
...
Write-Host " Deploying to IIS Staging Server..." -ForegroundColor Green
Write-Host " Site: dmspl91-001-site1" -ForegroundColor Green
Write-Host " URL: http://dmspl91-001-site1.ntempurl.com/" -ForegroundColor Green
Write-Host "==========================================" -ForegroundColor Green
...
for ($attempt = 1; $attempt -le $maxAttempts; $attempt++) {
    ...
    & $MSDeployPath -verb:sync `
        ...
        -dest:contentPath="dmspl91-001-site1",wmsvc="https://win6046.site4now.net:8172/MsDeploy.axd?site=dmspl91-001-site1",userName="dmspl91-001",password="$Password",authtype="Basic" `
...
& $MSDeployPath -verb:delete `
    -dest:contentPath="dmspl91-001-site1/app_offline.htm",wmsvc="https://win6046.site4now.net:8172/MsDeploy.axd?site=dmspl91-001-site1",userName="dmspl91-001",password="$Password",authtype="Basic" `
    -allowUntrusted 2>$null

if ($deploySuccess) {
    Write-Host "==========================================" -ForegroundColor Green
    Write-Host " SUCCESS! Backend API deployed to Staging (Site-1)!" -ForegroundColor Green
    Write-Host " Live URL: http://dmspl91-001-site1.ntempurl.com/" -ForegroundColor Green
    Write-Host "==========================================" -ForegroundColor Green
} else {
